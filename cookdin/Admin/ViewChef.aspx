<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ViewChef.aspx.cs" Inherits="Admin_ViewChef" %>
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">View Chef</h4>
                                </div>
                                    ...
                                    <i class="fa fa-mobile s16"></i>
                                        ...
                                        <div class="col-md-8">
                                            <div class="profile-name">
                                                <h3><asp:Label ID="lblUserName" runat="server" Text="Chef Name"></asp:Label></h3>
