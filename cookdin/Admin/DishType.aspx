<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="DishType.aspx.cs" Inherits="Admin_RegionalCuisine" %>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title">Add Dish Type</h4>
                                </div>
                                <div class="panel-body pt0 pb0">
                                    <div class="form-horizontal group-border stripped">
                                      ...
                                      <asp:Panel ID="pnlsuccess" runat="server" CssClass="bs-callout-info-success" Visible="false">
                                          <p>Dish Type Added Successfully.</p>
                                        </asp:Panel>
                                        
                                      <asp:Panel ID="pnlwarning" runat="server" CssClass="bs-callout-info-failer" Visible="false">
                                          <p>Dish Type Already Added.</p>
                                        </asp:Panel>


                               <div class="form-group">
                                            <label class="col-lg-2 col-md-3 control-label" for="">Dish Type Icon</label>
                               ...
                               <div class="form-group">
                                            <label class="col-lg-2 col-md-3 control-label" for="">Dish Type</label>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtDishType" Display="Dynamic" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>

                                             <div class="col-lg-10 col-md-9">
                                                 <asp:TextBox ID="txtDishType" runat="server" class="form-control required" name="default" area-required="true"></asp:TextBox>
...
<div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelClose panelRefresh">
                                <!-- Start .panel -->
                                <div class="panel-heading white-bg">
                                    <h4 class="panel-title">List Dish Type</h4>
                                </div>
	...
	<td class="center"><asp:Image ID="Image1" runat="server" src='<%# "../UploadIcon/"+Eval("Icon")%>' Height="70" Width="70"/></td>
     <td class="center"><%#Eval("Dish_Type_ID")%></td>
     
     <td class="center"><%#Eval("Dish_Type")%></td>
     <td class="center"><%#Eval("Description")%></td>
          <td class="center">
          
          <a class="btn btn-success mr5 mb10" href='DishType.aspx?eid=<%# Eval("Dish_Type_ID")%>'><i class="icon-trash icon-white"></i>Edit</a>
          <a class="btn btn-danger mr5 mb10" href='DishType.aspx?did=<%# Eval("Dish_Type_ID")%>'><i class="icon-trash icon-white"></i>Delete</a>
