<%@ Page Title="" Language="C#" MasterPageFile="~/Consumer/ConsumerMasterPage.master" AutoEventWireup="true" CodeFile="ViewDish.aspx.cs" Inherits="Consumer_ViewDish" %>
		...
		<div class="wrap clearfix">
			...
			<div class="row">
                ...
                <asp:TextBox ID="textboxDate" runat="server" CssClass="remove-border date-selector-height" placeholder="Date of Order Delivery"   AutoPostBack="True" ontextchanged="textboxDate_TextChanged"  ValidationGroup="addTocart" Height="37px"></asp:TextBox>
                                    ...
                                    <div class="form-dropdown1 dropdown-width" >
                                           <asp:DropDownList ID="ddlTime" runat="server" Width="100%" placeholder="Select the time of Delivery" Height="37px"></asp:DropDownList>
