<%@ Page Title="" Language="C#" MasterPageFile="~/Consumer/ConsumerMasterPage.master" AutoEventWireup="true" CodeFile="carttest.aspx.cs" Inherits="Consumer_carttest" %>
...
<style type="text/css">
    ...
    <main class="main" role="main">
		...
		<div class="wrap clearfix">
                <!--row-->
                <div class="row">
                <header style="visibility: visible; animation-name: fadeInLeft;" class="s-title wow fadeInLeft animated"><h1>Checkout</h1> </header>
                <!--content-->
                        ...
                        onitemcommand="DataListdishitem_ItemCommand">
                         <HeaderTemplate>
                          <div class="checkout-title">
                                    ...
                                    <div class="food-date text-center">Delivery Date</div>
                                    <div class="food-time text-center">Time</div>
                     ...
                     <ItemTemplate>
                         <div class="order-group">
                                    <div class="checkout-content">
                                        <div class="members"> <ul class=""> 
                                            <div class="avatar" style="margin-right:15px"><a href="">
                                                <img src='<%# "../Chef/upload/"+Eval("Dish_Image")%>' alt=""></a>
                                            </div>
                                            </ul>
                                            
                                            </div>
                                        
                                        <div class="food-amt text-center"><div><%#Eval("Dish_Name") %></div><div><asp:Label ID="lblChefUserName" runat="server" Text='<%#Eval("Chef_UserName") %>'></asp:Label></div></div>
                                        <div class="food-amt text-center"><span class="net_price"><%#Eval("Dish_Type") %></span></div> 
                                        <div class="food-amt text-center"><span class="net_price"> <asp:Label ID="lblDeliveryDate" runat="server" Text='<%#Eval("Order_Date", "{0:M-dd-yyyy}") %>'></asp:Label></span></div> 
          ...
          <%--  <div>--%>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server"><ContentTemplate>
                        ...
                        <asp:Label ID="lblcontactno" runat="server" Text="Label" Visible="true"></asp:Label>
                          ...
                          <asp:Button ID="Button5" runat="server" Text="" Style="display: none"   ></asp:Button>
                          

    <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="Pnlvarivicationpopup" TargetControlID="Button5" BehaviorID="mpe1" BackgroundCssClass="modalBackground" > </asp:ModalPopupExtender>
       ...
       <%-- <div class="body"> </div>--%>
          ...
          <%--  <div>--%>
                    	...
                    	<div class="f-row">
                                  ...
                                  <asp:TextBox ID="txtcode" runat="server" placeholder="Varification Code" ValidationGroup="verificationcode"></asp:TextBox>

                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtcode" 
                            Display="Dynamic" ForeColor="Red" Text="*" SetFocusOnError="True" ValidationGroup="verificationcode"></asp:RequiredFieldValidator>
						      </div>

                              <div class="f-row">
                                  <asp:Button ID="btnVarificationCheck" runat="server" Text="Submit" 
                                      ValidationGroup="verificationcode" onclick="btnVarificationCheck_Click"></asp:Button>
                                </div>
                                 
                                 <div class="f-row">
                                    <asp:Label ID="lblverificationerror" runat="server" Text="Invalid Varification Code" ForeColor="Red" Visible="false"></asp:Label>
                                 </div>
                               </ContentTemplate></asp:UpdatePanel> 
