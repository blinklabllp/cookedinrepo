<%@ Page Title="" Language="C#" MasterPageFile="~/Consumer/ConsumerMasterPage.master" AutoEventWireup="true" CodeFile="MyCart.aspx.cs" Inherits="Consumer_MyCart" %>
...
<style type="text/css">
   ...
   <%--  <asp:UpdatePanel ID="UpdatePanel1" runat="server"><ContentTemplate>--%>
        ...
        <table>
							...
							<tr>
                                <td rowspan="3" style="height: 88px;"> 
                                <div class="members"> 
                                    <ul class=""> 
                                ...
                                <td>
                                    ...
                                    <br /><br /><br />
                                    <asp:Label ID="lblcoupon" runat="server"  Font-Size="Small" ></asp:Label><br />
                                </td>
                                <td>
       ...
       <%-- </ContentTemplate></asp:UpdatePanel>--%>
				...
				<aside class="sidebar one-fourth" style="visibility: visible;">
                    ...
                    <asp:Label ID="lbladdressmessage" runat="server" Text="Please Select Delivery Address" ForeColor="Red" Visible="false"></asp:Label>
   ...
   <asp:Panel ID="pnlpopup" runat="server"  CssClass="modalPopup" Style="display: none" >
       <%-- <div class="body"> </div>--%>
          <div class="modal container popup-padding">
          <%--  <div>--%>
            <div class="f-row">
                            <table>
                             <tr>
                               <td class="form-dropdown-area"><asp:DropDownList ID="ddladdress" runat="server" onselectedindexchanged="ddladdress_SelectedIndexChanged"  AutoPostBack="True" ></asp:DropDownList></td>
                              ̥</tr>
                            </table>
                        </div>
                       <div class="f-row">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel2" runat="server"><ContentTemplate>
                        ...
                        <div class="f-row">
                           ...
                           <table>
                           <tr>
                              <td class="form-dropdown-area" style="width:50%">
                              ...
                              <td class="form-dropdown-area" style="width:50%">  <asp:DropDownList ID="ddlcity" runat="server" Width="100%"  placeholder="City" ></asp:DropDownList></td>
                        ...
                        <div class="f-row">
                          <table>
                           <tr>
                                     <td class="form-dropdown-area"><asp:DropDownList ID="ddlLandMark" runat="server" Width="100%"  placeholder="PinCode"></asp:DropDownList></td>
                        ...
                        <div class="f-row center">
						    <asp:Button ID="btncancel" runat="server" Text="Cancel" CssClass="btn-width-page btn-padding"> </asp:Button>
                            <asp:Button ID="Button4" runat="server" Text="Add" ValidationGroup="personal"  onclick="btnAddAddress_Click" CssClass="btn-width-page btn-padding"> </asp:Button>
                        </div> 
                    </div>
</asp:Panel>
				<!--//right sidebar-->
