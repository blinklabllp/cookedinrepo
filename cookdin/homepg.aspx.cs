...
public partial class homepg : System.Web.UI.Page
{
    ...
    private void Bind_Dish_List(SqlParameter[] p)
    {
       // SqlParameter[] p = new SqlParameter[1];
       // p[0] = new SqlParameter("@Mode",1);
        ...
        foreach (RepeaterItem item in Repeaterdish.Items)
        {
            ...
            //lblOfferPrice.Text = lblOfferPrice.Text + lblrupee.Text;
            //lblPrice.Text = lblPrice.Text + lblrupee.Text;
    ...
    private void Bind_PopUp_detail()
    {
         SqlParameter[] p = new SqlParameter[1];
        p[0] = new SqlParameter("@Mode",1);
        ddlarea.DataSource = con1.Select("SPH_Area_View",p);
    ...
    public void DishType_QueryString()
    {
        ...
        if (Request.QueryString.Get("date") != null && Request.QueryString.Get("id") != "")
