<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewDish.aspx.cs" Inherits="ViewDish" %>
                        ...
                        <Triggers> <asp:AsyncPostBackTrigger ControlID = "textboxDate" EventName="TextChanged" /></Triggers>
                             <ContentTemplate>
                                    ...
                                    <div class="form-dropdown1 dropdown-width">
                                           <asp:DropDownList ID="ddlTime" runat="server" Width="100%" CssClass="" placeholder="Select the time of Delivery" Height="37px"></asp:DropDownList>
