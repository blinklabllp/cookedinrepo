<%@ Page Title="" Language="C#" MasterPageFile="~/Chef/ChefMasterPage.master" AutoEventWireup="true" CodeFile="Chef_Profile.aspx.cs" Inherits="Chef_Profile" %>
			...
			<section class="content">
				...
				<div class="row">
					...
					<div style="visibility: visible;" class="my_account one-fourth">
						...
						<div class="container">
                            <h2>
                              <asp:Label ID="Label1" runat="server" Text="Chef Desai"></asp:Label>
							</h2> 
						</div>
					</div>
					<!--//profile left part-->
