<%@ Page Title="" Language="C#" MasterPageFile="~/Chef/ChefMasterPage.master" AutoEventWireup="true" CodeFile="EditDish.aspx.cs" Inherits="Chef_EditDish" %>
...
#close{
    ...
    width:30px;
    height:29px;
    background:url(../templete/image/close.png); no-repeat center center;
}
</style>
    ...
    <script type="text/javascript">
        ...
        function InitAutoCompl() {
            ...
            $("#<%=txtcuisine.ClientID %>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '<%=ResolveUrl("~/Service.asmx/GetAllCuisine_SingleSelection") %>',
                        data: "{ 'prefix': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                ...
                <section class="content full-width" style="visibility: visible;">
					<div class="submit_recipe container">
					        ...
					        <div class="f-row">  
                                     ...
                                     <asp:DataList ID="DataListIngridian" runat="server" RepeatDirection="Horizontal">
                                            <ItemTemplate>
                                               ...
                                               <%-- <asp:CheckBox ID="chking" runat="server" Text='<%# Eval("Ingridiant_Name") %>'   />--%>
                                                <asp:Label ID="lblid" runat="server" Text='<%# Eval("Ingridiant_ID") %>' Visible="false"></asp:Label>
                                                  <asp:Label ID="lblingri" runat="server" Text='<%# Eval("Ingridiant_Name") %>'></asp:Label>
                            ...
                            <section>
								...
								<h2>Uploaded Photos</h2>
                                        ...
                                        RepeatDirection="Horizontal" onitemcommand="DataListImage_ItemCommand">
                                        <ItemTemplate>
                    <center>
                                        ...
                                        <asp:Label ID="lblid" runat="server" Text='<%# Eval("Gallery_ID")%>' Visible="false"></asp:Label>
                                        <asp:Label ID="lbldishname" runat="server" Text='<%# Eval("Dish_Image")%>' Visible="false"></asp:Label>
                                       


                                        <a class="button gold" href="#">  <img id="dishimg" runat="server" src='<%# "../dishphotoupload/"+Eval("Dish_Image")%>' alt=''   height="100" width="100" />
                                        <div class="cross"> <asp:Button ID="close" runat="server" Text="X" CommandName="deleteimg"></asp:Button></div>
                                       </a>
					        ...
					        <div class="row"> 
								...
								<h2>Select Dish Photo</h2>
                                        <asp:FileUpload ID="file_upload" class="multi" runat="server" multiple="true" AllowMultiple="true" />
								</div>
                            </div>
							</section>
